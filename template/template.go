...
<head>
    ...
    <!--<![endif]-->
    <title>Lazarus Network | Sotreus Client Configuration</title>
    <!--[if gte mso 9]>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="column-top" width="280" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    <td class="text pb20" style="color:#ffffff; font-family:Arial,sans-serif; font-size:14px; line-height:26px; text-align:left; padding-bottom:20px;">Here is your requested Sotreus Client Configuration - <strong>{{.Client.Name}}</strong>  created on {{format .Client.Created}} for {{.SotreusName}} . Scan the Qrcode or open attached configuration file in WireGuard VPN Client App to Anonymize & Secure Your Digital Footprint.</td>
                                                                </tr>
                                                            </table>
                                                        </th>
                                                    </tr>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="p30-15" style="padding: 50px 30px;">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td class="h3 pb20" style="color:#ffffff; font-family:'Muli', Arial,sans-serif; font-size:25px; line-height:32px; text-align:left; padding-bottom:20px;">About Lazarus Network - Sotreus</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="text pb20" style="color:#ffffff; font-family:Arial,sans-serif; font-size:14px; line-height:26px; text-align:left; padding-bottom:20px;">Lazarus Network - Sotreus is based on WireGuard protocol which is an extremely simple yet fast and modern VPN that utilizes state-of-the-art cryptography. It aims to be faster, simpler, leaner, and more useful than IPsec/OpenVPN making it suitable for both small embedded devices like smartphones and fully loaded backbone routers.</td>
                                                                </tr>
                                                                <!-- Button -->
                                                                <tr>
                                                                    <td align="left">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="p30-15 bbrr" style="padding: 50px 30px; border-radius:0px 0px 26px 26px;" bgcolor="#0e264b">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td class="text-footer1 pb10" style="color:#c1cddc; font-family:'Muli', Arial,sans-serif; font-size:16px; line-height:20px; text-align:center; padding-bottom:10px;">Lazarus Network - Sotreus | Dedicated VPN Tunneling Solution</td>
                                        </tr>
                                        <tr>
...
func DumpEmail(client *model.Client, qrcodePngName string) ([]byte, error) {
	...
	return dump(t, struct {
		...
		SotreusName:   os.Getenv("SOTREUS_NAME"),
	})
}
